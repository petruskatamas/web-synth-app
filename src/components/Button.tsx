...
const ButtonStyles = {
    ...
    stop :
    "text-white bg-red-500 border border-gray-200  px-4 py-2 text-center font-bold text-xl rounded hover:bg-red-800 hover:rounded transition duration-300",
    default :
...
export const Button = ({
  ...
  return (
    <button className={`${ButtonStyles[variant]} ${className}`} onClick={onClick}>{label}</button>
  )
}